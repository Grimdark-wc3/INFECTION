...
**Раздражающее и скучное**
   ...
   * {-} доработать **кладбище**: **могильники** (разместить их на возвышении), добавить **культистов** (аколит, головорез, охотник на людей, громила, людоед вместо кучи мяса), **скелетов** убрать в **Подземелья**;
...
#### НЕЙТРАЛИЗАЦИЯ НАКАЗАНИЙ
   ...
   * {-} создана *escape-способность* **Бегство** для того чтобы избегать окружения;
