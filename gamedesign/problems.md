...
## Окружение
**Проблема**: зачастую игрок попадает в окружение, и просто умирает, без возможности спастись, хоть и потеряв много здоровья. Потом он возрождается и очень часто умирает опять.

**Решение**: эскейп способности по умолчанию: например увеличение скорости и возможность проходить сквозь других юнитов, или расталкивание врагов, или инвиз при бездействии.

# Падение производительности при большом числе монстров
**Проблема**: периодически при больших сражениях на слабых машинах могут возникать провисания ощутимые fps плоть до остановки кадров. Кроме того, возможны так же вылеты игры из-за утечек памяти.

**Решение**: выявлять при тестировании места с проседанием fps и принимать меры (например удалять тела) при выявлении лагов. Разработать и применять комплекс мер по устранению утечек памяти.